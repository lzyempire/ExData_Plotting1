...
##First, plot Time~Global Active Power
plot(hpc_time, hpc_day$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

##Second, plot Time~Voltage
plot(hpc_time, hpc_day$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

##Third, plot Time~Energy sub metering
...
##Fourth, plot Time~Global_reactive_power
plot(hpc_time, hpc_day$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
